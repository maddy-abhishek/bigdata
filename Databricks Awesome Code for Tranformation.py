...
storage_account = "olistdata"
application_id = "f6617ca4-e9ce-497c-9904-e4d9d55fa066"
directory_id = "033d66fb-a141-4aa8-913f-60e821b21660"

spark.conf.set(f"fs.azure.account.auth.type.{storage_account}.dfs.core.windows.net", "OAuth")
spark.conf.set(f"fs.azure.account.oauth.provider.type.{storage_account}.dfs.core.windows.net", "org.apache.hadoop.fs.azurebfs.oauth2.ClientCredsTokenProvider")
spark.conf.set(f"fs.azure.account.oauth2.client.id.{storage_account}.dfs.core.windows.net", application_id)
spark.conf.set(f"fs.azure.account.oauth2.client.secret.{storage_account}.dfs.core.windows.net", "PRo8Q~-iA~zAS5ITWB7AsIZyzNZHotyxlC36icOh")
...
customer_df = (
    ...
    .load("abfss://olistdata@olistdata.dfs.core.windows.net/bronze/olist_customers_dataset.csv")
)
...
base_path = "abfss://olistdata@olistdata.dfs.core.windows.net/bronze/"
...
hostname = "1acavz.h.filess.io"
database = "olistDataNoSQL_automobile"
port = "61034"
username = "olistDataNoSQL_automobile"
password = "45ed2067f85557c21694d51033a47b62c1a3e2b6"
...
final_df.write.mode("overwrite").parquet("abfss://olistdata@olistdata.dfs.core.windows.net/silver")